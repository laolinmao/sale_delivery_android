...
public final class SpanUtil {
    ...
    public static class SpanBuilder {
        ...
        private SpanBuilder onDecor(String section, boolean ignoreCase, Which which, DecorCallback decorCallback) {
         ...
         */
        public SpanBuilder setForeColor(final String section, final int color, boolean ignoreCase, Which which) {
         ...
         * 加上背景色 
         */
        public SpanBuilder setBackColor(String section, final int color, boolean ignoreCase, Which which) {
         ...
         * 设置为下标 
         */
        public SpanBuilder setAsSubscript(String section, Which which) {
         ...
         * 设置为上标 
         */
        public SpanBuilder setAsSuperscript(String section, Which which) {
         ...
         * 给片段设置下划线 
         */
        public SpanBuilder setUnderline(String section, Which which) {
         ...
         * 给片段添加删除线 
         */
        public SpanBuilder setStrikethrough(String section, Which which) {
         ...
         * 给片段的字体设置绝对大小 
         */
        public SpanBuilder setAbsSize(String section, final int size, Which which) {
         ...
         * 给片段的字体设置相对大小 
         */
        public SpanBuilder setRelSize(String section, final float proportion, Which which) {
         ...
         * 转为url字体片段 
         */
        public SpanBuilder setAsURL(String section, final String url, Which which) {
         ...
         * 设置字体风格（粗、斜、正常） 
         */
        public SpanBuilder setStyle(String section, final int style, Which which) {
         ...
         */
        public SpanBuilder setTypeface(String section, final String family, Which which) {
         ...
         *                   new EmbossMaskFilter(new float[] { 1, 1, 1 }, 0.4f, 6, 3.5f); 
         */
        public SpanBuilder setMask(String section, final MaskFilter maskFilter, Which which) {
         ...
         * 移除格式 
         */
        public SpanBuilder removeSpans( String section, Which which) {
         ...
         */
        public SpanBuilder removeSpans(String section) {
         ...
         * 移除格式，从某一个下标开始 
         */
        public SpanBuilder removeSpans(String section, int fromIndex) {
            String baseStr = getString();
