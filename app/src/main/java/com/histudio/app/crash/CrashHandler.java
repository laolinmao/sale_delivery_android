package com.histudio.app.crash;
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                File dir = new File(FileUtils.getExceptionsDirectory());
                if (!dir.exists()) {
                    dir.mkdirs();
                }
                FileOutputStream fos = new FileOutputStream(FileUtils.getExceptionsDirectory() + fileName);
